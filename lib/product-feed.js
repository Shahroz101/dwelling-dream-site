...
// The site has no slug column - the slug is derived from category + title, and
// the product page resolves it the same way. Changing a title or category
// therefore changes the URL; the feed id stays pinned to the immutable row id
// so Google keeps tracking the same product across such a rename.
